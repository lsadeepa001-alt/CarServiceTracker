    ...
    <div class="bg-white shadow-xl rounded-2xl border border-gray-100 p-6 mb-10">
        ...
        <form action="AddVehicleServlet" method="POST" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <input type="text" name="ownerUsername" placeholder="Who owns this?" required class="mt-1 w-full px-4 py-2 border rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            </div>
